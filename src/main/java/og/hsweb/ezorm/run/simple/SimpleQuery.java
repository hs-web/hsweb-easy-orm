...
import og.hsweb.ezorm.run.Query;
import og.hsweb.ezorm.run.simple.wrapper.TriggerWrapper;
...
class SimpleQuery<T> extends ValidatorAndTriggerSupport implements Query<T> {
    ...
    @Override
    public Query setParam(QueryParam param) {
    ...
    @Override
    public Query selectExcludes(String... fields) {
        this.queryParam.excludes(fields);
        return this;
    }

    @Override
    public Query where(String condition, Object value) {
        queryParam.where(condition, value);
        return this;
    }

    @Override
    public Query and(String condition, Object value) {
        queryParam.and(condition, value);
        return this;
    }

    @Override
    public Query or(String condition, Object value) {
