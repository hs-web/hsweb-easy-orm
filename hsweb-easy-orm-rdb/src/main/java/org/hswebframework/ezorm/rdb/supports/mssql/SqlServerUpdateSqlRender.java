...
import org.hswebframework.ezorm.rdb.supports.commons.CommonSqlRender;
import org.hswebframework.ezorm.rdb.supports.commons.SimpleSQL;
import org.hswebframework.ezorm.rdb.supports.commons.SimpleWhereSqlBuilder;
...
public class SqlServerUpdateSqlRender extends CommonSqlRender<UpdateParam> {
    ...
    public SqlServerUpdateSqlRender(Dialect dialect) {
