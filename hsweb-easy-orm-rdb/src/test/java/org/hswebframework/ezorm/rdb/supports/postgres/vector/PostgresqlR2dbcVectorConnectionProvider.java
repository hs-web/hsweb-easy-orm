...
public class PostgresqlR2dbcVectorConnectionProvider implements R2dbcConnectionProvider {


    Supplier<Mono<Connection>> connectionSupplier;

    @SneakyThrows
    public PostgresqlR2dbcVectorConnectionProvider() {

        String username = System.getProperty("postgres.username", "postgres");
        String password = System.getProperty("postgres.password", "admin");
        String url = System.getProperty("postgres.url", "127.0.0.1:" + PostgresqlVectorConnectionProvider.port);
